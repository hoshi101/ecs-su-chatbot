...
OUT_OF_SCOPE_SOFT_CLOSES = {
    "food": (
        "เรื่องอาหารผมอาจช่วยเลือกแทนไม่ได้ แต่ถ้าหิวอยู่ลองหาอะไรรองท้องก่อนนะครับ",
        "ผมยังแนะนำมื้ออาหารให้ไม่ได้ครับ แต่ก็อย่าปล่อยให้ท้องว่างนานนะครับ",
        "เรื่องกินอาจอยู่นอกขอบเขตของผม แต่ดูแลตัวเองและหาอะไรกินสักหน่อยนะครับ",
    ),
    "rest": (
        "ผมช่วยเรื่องนี้ได้ไม่มากนัก แต่พักสักนิดน่าจะช่วยให้ดีขึ้นนะครับ",
        "ถ้าเริ่มล้า ลองพักสายตาหรือพักผ่อนสักหน่อยก่อนนะครับ",
        "เรื่องนี้อาจอยู่นอกขอบเขตของผม แต่อย่าลืมดูแลตัวเองและพักบ้างนะครับ",
    ),
    "stress": (
        "ผมอาจช่วยแก้เรื่องนี้ตรงๆ ไม่ได้ แต่ค่อยๆ พักหายใจลึกๆ สักนิดก็ดีนะครับ",
        "ถ้ารู้สึกหนักเกินไป ลองพักก่อนสักหน่อย แล้วค่อยกลับมาจัดการทีละเรื่องนะครับ",
        "ดูแลตัวเองด้วยนะครับ ถ้าพักได้ลองพักก่อน แล้วค่อยเริ่มใหม่ก็ได้ครับ",
    ),
    "generic": (
        "เรื่องนี้อยู่นอกขอบเขตที่ผมช่วยได้ครับ แต่ถ้าเป็นข้อมูลเกี่ยวกับภาควิชา ผมพร้อมช่วยต่อครับ",
        "ผมอาจตอบเรื่องทั่วไปแบบนี้ได้ไม่ดีพอครับ ถ้าต้องการข้อมูลหลักสูตร อาจารย์ เอกสาร หรือข้อมูลติดต่อ ส่งมาได้เลยครับ",
        "ตอนนี้ผมช่วยเรื่องนี้ได้ไม่ครบครับ แต่ยังช่วยเรื่องข้อมูลของภาควิชาได้ เช่น หลักสูตร รายวิชา อาจารย์ และการติดต่อครับ",
        "เรื่องนี้ไม่ใช่ขอบเขตหลักของระบบครับ ถ้าอยากถามเรื่องหลักสูตร รายวิชา อาจารย์ หรือข้อมูลติดต่อ ผมช่วยได้ครับ",
    ),
}
